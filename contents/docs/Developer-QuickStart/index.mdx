...
| ------------------ | ------------------------------------------------------ | ---------------------------- |
| RPC URL            | https://testnet.hashkeychain.net                                | https://rpc2.sepolia.org     |
| Chain ID           | 133                                                    | 11155111                     |
| Currency Symbol    | HSK                                                    | ETH                          |
| Block Explorer URL | https://testnet-explorer.hashkeychain.net                       | https://sepolia.etherscan.io |
...
const config: HardhatUserConfig = {
  networks: {
    hashkeyTestnet: {
      url: "https://testnet.hashkeychain.net" || "",
      accounts:
...
```bash
forge create ... --rpc-url=https://testnet.hashkeychain.net --chain-id 133
```
...
1. Set up MetaMask with HashKey Chain Testnet using these parameters:
   ...
   * RPC URL: https://testnet.hashkeychain.net
   * Chain ID: 133
   * Currency Symbol: HSK
...
module.exports = {
  networks: {
    hashkeyTestnet: {
      provider: () =>
        new HDWalletProvider(process.env.PRIVATE_KEY, "https://testnet.hashkeychain.net"),
      network_id: 133,
    },
  }
}
...
const provider = new ethers.providers.JsonRpcProvider("https://testnet.hashkeychain.net")
```
