...
Proof-of-Stake is **highly relevant** to HashKey Chain. According to the provided documentation (`https://docs.hashkeychain.net/docs/About-HashKey-Chain`), HashKey Chain utilizes a combination of **Proof of Stake (PoS)** and **Proof of Authority (PoA)**.
